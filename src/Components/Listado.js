...
function Listado(props) {
  ...
  useEffect(() => {
    const endPoint =
      "https://api.themoviedb.org/3/discover/movie?api_key=cf80d99a3562682f7e670df7df66f082&language=es-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&with_watch_monetization_types=flatrate";
    axios.get(endPoint)
    .then( res => {
          ...
          return (
            <div className="col-3" key={index}>
              <div className="card my-4">
                ...
                {/* ejecutamos funcion q recibimos por las props */}
                {/*  data-movie-id={oneMovie.id} para capturar el id */}
